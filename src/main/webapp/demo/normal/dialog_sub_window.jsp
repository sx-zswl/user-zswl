...
<a href="#" class="btn_gentle" onclick='HT.openWin("http://www.baidu.com", "htWindow");'>点我打开新窗口</a>
<a href="#" class="btn_gentle" onclick='HT.openWin("http://www.baidu.com", "htWindow1");'>点我打开新窗口</a>
