...
<c:set var="pageTitle" value="Form Validation for Dynamically Disabled Demo"/>
...
<tr>
	<td colspan="2" align="center">
		<button type="button" class="btn_gentle orange" id="btn_do">禁&nbsp;&nbsp;止</button>
...
$().ready(function() {
	...
	$("#btn_cancel").on("click", function() {
		$("#item7td, #item8td").resumeValidate($frm);
	});
